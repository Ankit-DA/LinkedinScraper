...
url <- as.character("https://www.linkedin.com/directory/topics-")
alpha <- letters
for (i in alpha) {
  
  # URL of the LinkedIn page 
  user_url<-paste0(url,i,"/",sep = '')
  #user_url<-("https://www.linkedin.com/directory/topics-")
  print(user_url) 
...
write.csv(complist, file = "topics_list_e.csv", row.names = F)
